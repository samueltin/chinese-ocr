...
class FeatureIO(object):
    ...
    """
    def __init__(self, char_dict_path='/Users/samueltin/Projects/samuel/CRNN_Tensorflow_Chinese/CRNN_Tensorflow/data/char_dict/char_dict.json',
                 ord_2_index_map_dict_path='/Users/samueltin/Projects/samuel/CRNN_Tensorflow_Chinese/CRNN_Tensorflow/data/char_dict/ord_2_index_map.json',
                 index_2_ord_map_dict_path='/Users/samueltin/Projects/samuel/CRNN_Tensorflow_Chinese/CRNN_Tensorflow/data/char_dict/index_2_ord_map.json'):
        self.__char_list = CharDictBuilder.read_char_dict(char_dict_path)
        self.__ord_2_index_map = CharDictBuilder.read_ord_2_index_map_dict(ord_2_index_map_dict_path)
        self.__index_2_ord_map = CharDictBuilder.read_index_2_ord_map_dict(index_2_ord_map_dict_path)
        return
